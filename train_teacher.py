...
def parse_option():
    ...
    parser.add_argument('--model', type=str, default='resnet110',
                        choices=['resnet8', 'resnet14', 'resnet20', 'resnet32', 'resnet44', 'resnet56', 'resnet110', 'ResNet18', 'ResNet34', 
                                 ...
                                 'vgg8', 'vgg11', 'vgg13', 'vgg16', 'vgg19', 'vgg8_imagenet', 'shufflenet_v2_x0_5', 'ShuffleV2_0_5',  'MobileNetV2_Imagenet',
                                 'MobileNetV2', 'ShuffleV1', 'ShuffleV2', 'ResNet50', 'ResNet18', 'ShuffleV2_Imagenet', 'ResNet34x2', 'resnet32x4', 'ResNet101'])
    ...
    opt.model_path = './save/CAMKD/teachers/models'
    opt.tb_path = './save/CAMKD/teachers/tensorboard'
